...
const [loading,setLoading]=useState(false)
    ...
    <div className='flex w-full items-center justify-center min-h-screen p-4 bg-[#fff9f6]'>
      <div className='bg-white rounded-xl shadow-lg w-full max-w-md p-8'>
        <div className='flex items-center  gap-4 mb-4'>
          <IoIosArrowRoundBack size={30} className='text-[#e23744] cursor-pointer' onClick={()=>navigate("/signin")}/>
          <h1 className='text-2xl font-bold text-center text-[#e23744]'>Forgot Password</h1>
        </div>
        {step == 1
          &&
          <div>
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#e23744] text-white hover:bg-[#c72333] cursor-pointer`} onClick={handleSendOtp} disabled={loading}>
 ...
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#e23744] text-white hover:bg-[#c72333] cursor-pointer`} onClick={handleVerifyOtp} disabled={loading}>
 ...
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#e23744] text-white hover:bg-[#c72333] cursor-pointer`} onClick={handleResetPassword} disabled={loading}>

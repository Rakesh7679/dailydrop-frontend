...
function EditItem() {
            ...
            <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100'>
                <div className='flex flex-col items-center mb-6'>
                    <div className='bg-orange-100 p-4 rounded-full mb-4'>
                        <FaUtensils className='text-[#e23744] w-16 h-16' />
                    </div>
 ...
 <option value="non veg" >non veg</option>
                    ...
                    <button className='w-full bg-[#e23744] text-white px-6 py-3 rounded-lg font-semibold shadow-md hover:bg-[#c72333] transition-all duration-200 cursor-pointer' disabled={loading}>

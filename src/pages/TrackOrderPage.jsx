...
setLiveLocations(prev=>({
  ...
  [deliveryBoyId]:{lat:latitude,lon:longitude}
    ...
    return (
        <div className='max-w-4xl mx-auto p-4 pb-20 md:pb-4 flex flex-col gap-6'>
      ...
      {currentOrder?.shopOrders?.map((shopOrder,index)=>(
        <div className='bg-white p-4 rounded-lg shadow-md border border-gray-200 space-y-4' key={index}>
         <div>
            <p className='text-lg font-bold mb-2 text-[#e23744]'>{shopOrder.shop.name}</p>

...
<span className='text-sm'>status: <span className='font-semibold capitalize text-[#e23744]'>{data.shopOrders.status}</span>
</span>

<select  className='rounded-lg border px-3 py-1 text-sm focus:outline-none focus:ring-2 border-[#e23744] text-[#e23744]' onChange={(e)=>handleUpdateStatus(data._id,data.shopOrders.shop._id,e.target.value)}>
